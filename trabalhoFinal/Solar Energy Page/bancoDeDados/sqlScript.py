...
CREATE TABLE "hybrid" (
    "hybrid_id" int GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    "hybrid_status" varchar(255) NOT NULL DEFAULT 'ativo',
    
    "hybrid_kwhrdia" varchar(255),
    "hybrid_energiasol" varchar (255),
    "hybrid_estado" varchar(255),
    "hybrid_cidade" varchar(255),
    
    "hybrid_bateriavolts" varchar(255),
    "hybrid_energiadiareserva" varchar(255),
    
    "hybrid_paineltipo" varchar(255),
    "hybrid_modulowatt" varchar(255),

    "hybrid_temperaturaopcao" varchar(255),
    "hybrid_perdasinversor" varchar(255),
    "hybrid_fatorsegurancainversor" varchar(255),
    "hybrid_perdascabo" varchar(255),
    "hybrid_perdasincompatibilidade" varchar(255),
    "hybrid_perdassujeira" varchar(255),
    "hybrid_profundidade" varchar(255),
    "hybrid_bateriaeficiencia" varchar(255)
